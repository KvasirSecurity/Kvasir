...
window.Mousetrap = (function() {
    ...
    function _stop(e) {
        ...
        // if the element has the class "mousetrap_off" then stop
        if ((' ' + element.className + ' ').indexOf(' mousetrap_off ') > -1 ) {
            return true;
        }
    ...
    return {
         ...
         */
        pause: function() {
            console.log('Pausing Mousetrap');
            if (typeof _saved_callbacks != 'undefined') {
                console.log('Uh, already have a saved state, ignoring');
                return;
            }
         ...
         */
        unpause: function() {
            console.log('Unpausing Mousetrap');
            if (typeof _saved_callbacks == 'undefined') {
                console.log('No saved callback state, ignoring');
                return;
            }
